...
const Project : React.FC<PropTypes> = ({ title, image, description, techstack, previewLink, githubLink,id } )=> {
  return (
    <article className="rounded-xl mt-10 overflow-hidden h-auto shadow-xl shadow-slate-300 dark:shadow-slate-900" key={id}>
      <img src={image} style={{ height: '200px',width:"100%" }} alt="" loading="lazy" />
      <div className="dark:bg-dark-card p-4 rounded-4px h-full">
